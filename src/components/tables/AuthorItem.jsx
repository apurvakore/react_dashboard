...
export const AuthorItem = ({ image, title, icon1, icon2, icon3, icon4, budget, width, color1, color2 }) => {
  const gradientStyle = {
  ...
  return (
    <div className="row px-4 flex space-x-2 border-t py-1">
        <div className="col-1 w-[40%] flex space-x-2 items-center justify-start">
        ...
        <div className="col-3 w-[15%] py-4 text-[13px] font-semibold text-[#68758F]">
            {budget}
        </div>

        <div className="col-4 w-[15%] flex items-center px-2">
