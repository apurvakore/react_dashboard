...
export const Platform = () => {
  return (
    <div className="flex flex-col md:flex-row md:space-x-5 space-y-5 md:space-y-0">
      <div className="w-[100%] md:w-[33%] mt-3 md:mt-0 bg-white rounded-xl">
        <div className="">
              ...
              {platformInfoData.account.map((item, index) => (
                <div key={index} className="pt-5 pb-2">
                  <label className="inline-flex items-center cursor-pointer">
                    ...
                    <span className="ms-3 text-sm font-medium text-[#67748E] ">
                      {item.name}
                    </span>
                  </label>
                </div>
      ...
      <div className="w-[100%] md:w-[33%] mt-3 bg-white rounded-xl">
