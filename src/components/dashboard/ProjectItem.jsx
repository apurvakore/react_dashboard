...
export const ProjectItem = ({ image, title, icon1, icon2, icon3, icon4, budget, width, color1, color2 }) => {
  ...
  return (
    <div className="row px-4 flex space-x-2 border-t py-1">
      <div className="col-1 w-[50%] md:w-[45%] flex space-x-2 items-center justify-start">
        <img className="w-[40px]" src={image} alt={title} />
        <div className="text-sm font-semibold text-[#344767]">{title}</div>
      </div>

      <div className="col-2 w-[30%] md:w-[15%] pr-[3px] py-4">
      ...
      <div className="col-3 w-[20%] md:w-[10%] py-4 text-[13px] font-semibold text-[#68758F]">
        {budget}
      </div>

      <div className="hidden col-4 w-[30%] md:flex items-center px-2">
